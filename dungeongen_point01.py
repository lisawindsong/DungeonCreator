...
mapscrollx = Scrollbar(top)
mapscrollx.pack( side = RIGHT, fill = Y)
mapscrolly = Scrollbar(top)
mapscrolly.pack(side = BOTTOM, fill = Y)
#leftframe = Tkinter.Frame(top)
tehcanvas = Canvas(top, bg="gray30", height = 800, width = 900, xscrollcommand = mapscrollx.set, yscrollcommand = mapscrolly.set)
